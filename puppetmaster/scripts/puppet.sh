...
# Install ruby gems for classifications.rb (refer wwt-puppet-control production branch in scripts dir)
...
/bin/mv -f /tmp/*.pem /etc/puppetlabs/code/keys/
